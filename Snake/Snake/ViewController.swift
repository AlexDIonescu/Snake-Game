...
protocol SpeedProtocol {
    func chooseSpeed(velocity: Double)
}
...
class ViewController: UIViewController, UpdateText, AlertShow, SnakeSound {
    ...
    func playMoveSound() {
        ...
        //        let source = Bundle.main.path(forResource: "grass steps", ofType: "mp3")
        //        let url = URL(fileURLWithPath: source!)
        //
        //            do {
        //
    ...
    var speedDelegate: SpeedProtocol?
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(backgroundAction), name: UIApplication.didEnterBackgroundNotification, object: nil)
    ...
    @IBAction func infoButtonTap(_ sender: UIButton) {
        ...
        scoreAlert.addAction(UIAlertAction(title: "Dismiss", style: .default, handler: nil))
